...
export const updatePolicy = async (req,res) => {
    const {groupId, usbmtp, printing, browserUpload, bluetooth, clipboard, snipping, blockedApps, clipboardWhiteLists} = req.body;

    const policyData = new PolicyDetails({groupId, usbmtp, printing, browserUpload, bluetooth, clipboard, snipping, blockedApps, clipboardWhiteLists});
