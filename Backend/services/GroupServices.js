...
export const addGroupLogic = async (groupData) => {
    try {
        ...
        await pool.query(`INSERT INTO policy(groupId, usb, mtp, printing, browserUpload, bluetooth, clipboard, snipping) VALUES (?, true, true, true, true, true, true, true);`, [groupId]);
